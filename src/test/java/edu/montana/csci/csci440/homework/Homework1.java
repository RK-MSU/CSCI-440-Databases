...
public class Homework1 extends DBTest {
    ...
    void selectArtistsWhoseNameHasAnAInIt(){
        List<Map<String, Object>> results = executeSQL("SELECT * FROM artists AS a WHERE a.Name LIKE '%a%'");
    ...
    void selectAllArtistsWithMoreThanOneAlbum(){
        List<Map<String, Object>> results = executeSQL(
                "SELECT a.Name, (SELECT COUNT(albums.AlbumId) FROM albums WHERE albums.ArtistId = a.ArtistId) AS albums_count FROM artists AS a WHERE albums_count > 1");
